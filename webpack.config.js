	...
	entry: './src/App.jsx', // entry file
  	...
  	resolve: { // These options change how modules are resolved
    	...
    	alias: { // Create aliases
      	images: path.resolve(__dirname, '/public/assets/img')  // public/assets/images alias
    	}
  	},
  	module: {
    	rules: [ // loader rules
		    ...
		    // },
		    {
		    ...
		    },
      		{
		        ...
		        loaders: ['file-loader?context=public/assets/images/&name=images/[path][name].[ext]', {  // images loader
